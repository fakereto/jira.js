...
export class Avatars {
  ...
  async getAllSystemAvatars<T = Models.SystemAvatars>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/avatar/${type}/system`,
      method: 'GET',
    };
  ...
  async getAvatars<T = Models.Avatars>(parameters: Parameters.GetAvatars, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/universal_avatar/type/${parameters.type}/owner/${parameters.entityId}`,
      method: 'GET',
    };
  ...
  async deleteAvatar<T = void>(parameters: Parameters.DeleteAvatar, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/universal_avatar/type/${parameters.type}/owner/${parameters.owningObjectId}/avatar/${parameters.id}`,
      method: 'DELETE',
    };
  ...
  async getAvatarImageByType<T = Models.AvatarWithDetails>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/universal_avatar/view/type/${type}`,
      method: 'GET',
  ...
  async getAvatarImageByID<T = Models.AvatarWithDetails>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/universal_avatar/view/type/${parameters.type}/avatar/${parameters.id}`,
      method: 'GET',
      responseType: 'arraybuffer',
      params: {
        size: parameters.size,
  ...
  async getAvatarImageByOwner<T = Models.AvatarWithDetails>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/universal_avatar/view/type/${parameters.type}/owner/${parameters.entityId}`,
      method: 'GET',
      responseType: 'arraybuffer',
      params: {
        size: parameters.size,
