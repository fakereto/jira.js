...
export class Dashboards {
  ...
  async bulkEditDashboards<T = Models.BulkEditShareableEntity>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/dashboard/bulk/edit',
      method: 'PUT',
      data: {
  ...
  async getAllAvailableDashboardGadgets<T = Models.AvailableDashboardGadgetsResponse>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/dashboard/gadgets',
      method: 'GET',
    };
  ...
  async getDashboardsPaginated<T = Models.PageDashboard>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/dashboard/search',
      method: 'GET',
      params: {
  ...
  async getAllGadgets<T = Models.DashboardGadgetResponse>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${dashboardId}/gadget`,
      method: 'GET',
      params: {
  ...
  async addGadget<T = Models.DashboardGadget>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.dashboardId}/gadget`,
      method: 'POST',
      data: {
  ...
  async updateGadget<T = void>(parameters: Parameters.UpdateGadget, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.dashboardId}/gadget/${parameters.gadgetId}`,
      method: 'PUT',
      data: {
        color: parameters.color,
        position: parameters.position,
  ...
  async getDashboardItemPropertyKeys<T = Models.PropertyKeys>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.dashboardId}/items/${parameters.itemId}/properties`,
      method: 'GET',
    };
  ...
  async getDashboardItemProperty<T = Models.EntityProperty>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.dashboardId}/items/${parameters.itemId}/properties/${parameters.propertyKey}`,
      method: 'GET',
    };
  ...
  async getDashboard<T = Models.Dashboard>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${id}`,
      method: 'GET',
    };
  ...
  async updateDashboard<T = Models.Dashboard>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.id}`,
      method: 'PUT',
      data: {
        description: parameters.description,
        editPermissions: parameters.editPermissions,
  ...
  async copyDashboard<T = Models.Dashboard>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/dashboard/${parameters.id}/copy`,
      method: 'POST',
      data: {
        description: parameters.description,
        editPermissions: parameters.editPermissions,
