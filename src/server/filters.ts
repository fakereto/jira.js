...
export class Filters {
  ...
  async getFavouriteFilters<T = Models.Filter[]>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/filter/favourite',
      method: 'GET',
      params: {
        expand: parameters?.expand,
      },
  ...
  async getFiltersPaginated<T = Models.PageFilterDetails>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/filter/search',
      method: 'GET',
      params: {
  ...
  async updateFilter<T = Models.Filter>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/filter/${parameters.id}`,
      method: 'PUT',
      params: {
        expand: parameters.expand,
        overrideSharePermissions: parameters.overrideSharePermissions,
  ...
  async getColumns<T = Models.ColumnItem[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/filter/${id}/columns`,
      method: 'GET',
    };
   ...
   * https://your-domain.atlassian.net/rest/api/latest/filter/10000/columns`
   *
   * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
  ...
  async setColumns<T = unknown>(parameters: Parameters.SetColumns, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/filter/${parameters.id}/columns`,
      method: 'PUT',
  ...
  async setFavouriteForFilter<T = Models.Filter>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/filter/${id}/favourite`,
      method: 'PUT',
      params: {
        expand: typeof parameters !== 'string' && parameters.expand,
      },
  ...
  async changeFilterOwner<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/filter/${parameters.id}/owner`,
      method: 'PUT',
      data: {
        accountId: parameters.accountId,
      },
