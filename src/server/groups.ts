...
export class Groups {
  ...
  async bulkGetGroups<T = Models.PageGroupDetails>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/group/bulk',
      method: 'GET',
      params: {
  ...
  async getUsersFromGroup<T = Models.PageUserDetails>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/group/member',
      method: 'GET',
      params: {
        groupname: parameters.groupname,
        groupId: parameters.groupId,
  ...
  async addUserToGroup<T = Models.Group>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/group/user',
      method: 'POST',
      params: {
        groupname: parameters.groupname,
        groupId: parameters.groupId,
  ...
  async findGroups<T = Models.FoundGroups>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/groups/picker',
      method: 'GET',
      params: {
