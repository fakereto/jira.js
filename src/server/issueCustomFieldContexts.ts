...
export class IssueCustomFieldContexts {
  ...
  async getContextsForField<T = Models.PageCustomFieldContext>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${fieldId}/context`,
      method: 'GET',
      params: {
  ...
  async createCustomFieldContext<T = Models.CreateCustomFieldContext>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context`,
      method: 'POST',
      data: {
        id: parameters.id,
  ...
  async getDefaultValues<T = Models.PageCustomFieldContextDefaultValue>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${fieldId}/context/defaultValue`,
      method: 'GET',
      params: {
        contextId: typeof parameters !== 'string' && parameters.contextId,
        startAt: typeof parameters !== 'string' && parameters.startAt,
  ...
  async setDefaultValues<T = void>(parameters: Parameters.SetDefaultValues, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/defaultValue`,
      method: 'PUT',
      data: {
  ...
  async getIssueTypeMappingsForContexts<T = Models.PageIssueTypeToContextMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${fieldId}/context/issuetypemapping`,
      method: 'GET',
      params: {
        contextId: typeof parameters !== 'string' && parameters.contextId,
        startAt: typeof parameters !== 'string' && parameters.startAt,
  ...
  async getCustomFieldContextsForProjectsAndIssueTypes<T = Models.PageContextForProjectAndIssueType>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/mapping`,
      method: 'POST',
      params: {
  ...
  async getProjectContextMapping<T = Models.PageCustomFieldContextProjectMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${fieldId}/context/projectmapping`,
      method: 'GET',
      params: {
        contextId: typeof parameters !== 'string' && parameters.contextId,
        startAt: typeof parameters !== 'string' && parameters.startAt,
  ...
  async updateCustomFieldContext<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async addIssueTypesToContext<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/issuetype`,
      method: 'PUT',
      data: {
        issueTypeIds: parameters.issueTypeIds,
      },
  ...
  async removeIssueTypesFromContext<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/issuetype/remove`,
      method: 'POST',
      data: {
        issueTypeIds: parameters.issueTypeIds,
      },
  ...
  async assignProjectsToCustomFieldContext<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/project`,
      method: 'PUT',
      data: {
        projectIds: parameters.projectIds,
      },
  ...
  async removeCustomFieldContextFromProjects<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/project/remove`,
      method: 'POST',
      data: {
        projectIds: parameters.projectIds,
      },
