...
export class IssueCustomFieldOptions {
  ...
  async getCustomFieldOption<T = Models.CustomFieldOption>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/customFieldOption/${id}`,
      method: 'GET',
    };
  ...
  async getOptionsForContext<T = Models.PageCustomFieldContextOption>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/option`,
      method: 'GET',
      params: {
  ...
  async reorderCustomFieldOptions<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/option/move`,
      method: 'PUT',
      data: {
  ...
  async deleteCustomFieldOption<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}/context/${parameters.contextId}/option/${parameters.optionId}`,
      method: 'DELETE',
    };
