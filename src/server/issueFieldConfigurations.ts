...
export class IssueFieldConfigurations {
  ...
  async getAllFieldConfigurations<T = Models.PageBeanFieldConfigurationDetails>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/fieldconfiguration',
      method: 'GET',
      params: {
  ...
  async updateFieldConfiguration<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/fieldconfiguration/${parameters.id}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async getFieldConfigurationItems<T = Models.PageFieldConfigurationItem>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/fieldconfiguration/${parameters.id}/fields`,
      method: 'GET',
      params: {
        startAt: parameters.startAt,
        maxResults: parameters.maxResults,
  ...
  async getAllFieldConfigurationSchemes<T = Models.PageFieldConfigurationScheme>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/fieldconfigurationscheme',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getFieldConfigurationSchemeMappings<T = Models.PageFieldConfigurationIssueTypeItem>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/fieldconfigurationscheme/mapping',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getFieldConfigurationSchemeProjectMapping<T = Models.PageFieldConfigurationSchemeProjects>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/fieldconfigurationscheme/project',
      method: 'GET',
      params: {
        startAt: parameters.startAt,
        maxResults: parameters.maxResults,
  ...
  async updateFieldConfigurationScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/fieldconfigurationscheme/${parameters.id}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async setFieldConfigurationSchemeMapping<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/fieldconfigurationscheme/${parameters.id}/mapping`,
      method: 'PUT',
      data: {
  ...
  async removeIssueTypesFromGlobalFieldConfigurationScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/fieldconfigurationscheme/${parameters.id}/mapping/delete`,
      method: 'POST',
      data: {
