...
export class IssueFields {
  ...
  async getFieldsPaginated<T = Models.PageField>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/field/search',
      method: 'GET',
      params: {
  ...
  async getTrashedFieldsPaginated<T = Models.PageField>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/field/search/trashed',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async updateCustomField<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.fieldId}`,
      method: 'PUT',
      data: {
        description: parameters.description,
        name: parameters.name,
  ...
  async deleteCustomField<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.id}`,
      method: 'DELETE',
    };
  ...
  async restoreCustomField<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.id}/restore`,
      method: 'POST',
    };
  ...
  async trashCustomField<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${parameters.id}/trash`,
      method: 'POST',
    };
