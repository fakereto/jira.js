...
export class IssueNotificationSchemes {
  ...
  async getNotificationSchemes<T = Models.PageNotificationScheme>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/notificationscheme',
      method: 'GET',
      params: {
  ...
  async getNotificationSchemeToProjectMappings<T = Models.NotificationSchemeAndProjectMappingPage>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/notificationscheme/project',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getNotificationScheme<T = Models.NotificationScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/notificationscheme/${id}`,
      method: 'GET',
      params: {
  ...
  async updateNotificationScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/notificationscheme/${parameters.id}`,
      method: 'PUT',
      data: {
        description: parameters.description,
        name: parameters.name,
  ...
  async deleteNotificationScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/notificationscheme/${parameters.notificationSchemeId}`,
      method: 'DELETE',
    };
  ...
  async removeNotificationFromNotificationScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/notificationscheme/${parameters.notificationSchemeId}/notification/${parameters.notificationId}`,
      method: 'DELETE',
    };
