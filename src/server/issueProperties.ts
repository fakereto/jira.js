...
export class IssueProperties {
  ...
  async bulkSetIssuesProperties<T = unknown>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issue/properties',
      method: 'POST',
      data: {
  ...
  async bulkSetIssuePropertiesByIssue<T = unknown>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issue/properties/multi',
      method: 'POST',
      data: {
  ...
  async bulkSetIssueProperty<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/properties/${parameters.propertyKey}`,
      method: 'PUT',
      data: {
  ...
  async getIssuePropertyKeys<T = Models.PropertyKeys>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/properties`,
      method: 'GET',
    };
  ...
  async getIssueProperty<T = Models.EntityProperty>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/properties/${parameters.propertyKey}`,
      method: 'GET',
    };
