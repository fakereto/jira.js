...
export class IssueSecuritySchemes {
  ...
  async getIssueSecuritySchemes<T = Models.SecuritySchemes>(callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes',
      method: 'GET',
    };
  ...
  async getSecurityLevels<T = Models.PageSecurityLevel>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes/level',
      method: 'GET',
      params: {
  ...
  async setDefaultLevels<T = void>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes/level/default',
      method: 'PUT',
      data: {
  ...
  async getSecurityLevelMembers<T = Models.PageSecurityLevelMember>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes/level/member',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async searchProjectsUsingSecuritySchemes<T = Models.PageIssueSecuritySchemeToProjectMapping>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes/project',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async searchSecuritySchemes<T = Models.PageSecuritySchemeWithProjects>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuesecurityschemes/search',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getIssueSecurityScheme<T = Models.SecurityScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.id}`,
      method: 'GET',
    };
  ...
  async deleteSecurityScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.schemeId}`,
      method: 'DELETE',
    };
  ...
  async addSecurityLevel<T = void>(parameters: Parameters.AddSecurityLevel, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.schemeId}/level`,
      method: 'PUT',
      data: {
        levels: parameters.levels,
      },
  ...
  async updateSecurityLevel<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.schemeId}/level/${parameters.levelId}`,
      method: 'PUT',
      data: {
        description: parameters.description,
        name: parameters.name,
  ...
  async addSecurityLevelMembers<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.schemeId}/level/${parameters.levelId}/member`,
      method: 'PUT',
      data: {
  ...
  async removeMemberFromSecurityLevel<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuesecurityschemes/${parameters.schemeId}/level/${parameters.levelId}/member/${parameters.memberId}`,
      method: 'DELETE',
    };
