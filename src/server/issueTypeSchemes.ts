...
export class IssueTypeSchemes {
  ...
  async getAllIssueTypeSchemes<T = Models.PageIssueTypeScheme>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescheme',
      method: 'GET',
      params: {
  ...
  async getIssueTypeSchemesMapping<T = Models.PageIssueTypeSchemeMapping>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescheme/mapping',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getIssueTypeSchemeForProjects<T = Models.PageIssueTypeSchemeProjects>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescheme/project',
      method: 'GET',
      params: {
        startAt: parameters.startAt,
        maxResults: parameters.maxResults,
  ...
  async updateIssueTypeScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescheme/${parameters.issueTypeSchemeId}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async addIssueTypesToIssueTypeScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescheme/${parameters.issueTypeSchemeId}/issuetype`,
      method: 'PUT',
      data: {
        issueTypeIds: parameters.issueTypeIds,
      },
  ...
  async reorderIssueTypesInIssueTypeScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescheme/${parameters.issueTypeSchemeId}/issuetype/move`,
      method: 'PUT',
      data: {
        issueTypeIds: parameters.issueTypeIds,
  ...
  async removeIssueTypeFromIssueTypeScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescheme/${parameters.issueTypeSchemeId}/issuetype/${parameters.issueTypeId}`,
      method: 'DELETE',
    };
