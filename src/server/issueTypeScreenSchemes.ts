...
export class IssueTypeScreenSchemes {
  ...
  async getIssueTypeScreenSchemes<T = Models.PageIssueTypeScreenScheme>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescreenscheme',
      method: 'GET',
      params: {
  ...
  async getIssueTypeScreenSchemeMappings<T = Models.PageIssueTypeScreenSchemeItem>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescreenscheme/mapping',
      method: 'GET',
      params: {
        startAt: parameters?.startAt,
        maxResults: parameters?.maxResults,
  ...
  async getIssueTypeScreenSchemeProjectAssociations<T = Models.PageIssueTypeScreenSchemesProjects>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetypescreenscheme/project',
      method: 'GET',
      params: {
        startAt: parameters.startAt,
        maxResults: parameters.maxResults,
  ...
  async updateIssueTypeScreenScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescreenscheme/${parameters.issueTypeScreenSchemeId}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async appendMappingsForIssueTypeScreenScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescreenscheme/${parameters.issueTypeScreenSchemeId}/mapping`,
      method: 'PUT',
      data: {
        issueTypeMappings: parameters.issueTypeMappings,
      },
  ...
  async updateDefaultScreenScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescreenscheme/${parameters.issueTypeScreenSchemeId}/mapping/default`,
      method: 'PUT',
      data: {
  ...
  async removeMappingsFromIssueTypeScreenScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescreenscheme/${parameters.issueTypeScreenSchemeId}/mapping/remove`,
      method: 'POST',
      data: {
  ...
  async getProjectsForIssueTypeScreenScheme<T = Models.PageProjectDetails>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetypescreenscheme/${parameters.issueTypeScreenSchemeId}/project`,
      method: 'GET',
      params: {
        startAt: parameters.startAt,
        maxResults: parameters.maxResults,
