...
export class IssueTypes {
  ...
  async getIssueTypesForProject<T = Models.IssueTypeDetails[]>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issuetype/project',
      method: 'GET',
      params: {
  ...
  async getIssueType<T = Models.IssueTypeDetails>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetype/${parameters.id}`,
      method: 'GET',
    };
  ...
  async getAlternativeIssueTypes<T = Models.IssueTypeDetails[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetype/${parameters.id}/alternatives`,
      method: 'GET',
    };
   ...
   * 'https://your-domain.atlassian.net/rest/api/latest/issuetype/{issueTypeId}'This`
   *
  ...
  async createIssueTypeAvatar<T = Models.Avatar>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issuetype/${parameters.id}/avatar2`,
      method: 'POST',
      params: {
        x: parameters.x,
        y: parameters.y,
