...
export class Issues {
  ...
  async archiveIssuesAsync<T = unknown>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issue/archive',
      method: 'POST',
      data: {
        jql: parameters.jql,
      },
  ...
  async createIssues<T = Models.CreatedIssues>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issue/bulk',
      method: 'POST',
      data: {
  ...
  async unarchiveIssues<T = Models.IssueArchivalSync>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issue/unarchive',
      method: 'PUT',
      data: {
        issueIdsOrKeys: parameters.issueIdsOrKeys,
      },
  ...
  async getIssue<T = Models.Issue>(parameters: Parameters.GetIssue, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}`,
      method: 'GET',
      params: {
        fields: parameters.fields,
  ...
  async assignIssue<T = void>(parameters: Parameters.AssignIssue, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/assignee`,
      method: 'PUT',
      data: {
  ...
  async getChangeLogs<T = Models.PageChangelog>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/changelog`,
      method: 'GET',
      params: {
  ...
  async getChangeLogsByIds<T = Models.PageOfChangelogs>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/changelog/list`,
      method: 'POST',
      data: {
  ...
  async getEditIssueMeta<T = Models.IssueUpdateMetadata>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/editmeta`,
      method: 'GET',
      params: {
        overrideScreenSecurity: parameters.overrideScreenSecurity,
        overrideEditableFlag: parameters.overrideEditableFlag,
  ...
  async notify<T = void>(parameters: Parameters.Notify, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/notify`,
      method: 'POST',
      data: {
  ...
  async getTransitions<T = Models.Transitions>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/issue/${parameters.issueIdOrKey}/transitions`,
      method: 'GET',
      params: {
        expand: parameters.expand,
  ...
  async exportArchivedIssues<T = Models.ExportArchivedIssuesTaskProgress>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/issues/archive/export',
      method: 'PUT',
      data: {
