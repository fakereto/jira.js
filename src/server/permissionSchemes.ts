...
export class PermissionSchemes {
  ...
  async getPermissionScheme<T = Models.PermissionScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/permissionscheme/${parameters.schemeId}`,
      method: 'GET',
      params: {
        expand: parameters.expand,
      },
  ...
  async getPermissionSchemeGrants<T = Models.PermissionGrants>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/permissionscheme/${parameters.schemeId}/permission`,
      method: 'GET',
      params: {
        expand: parameters.expand,
      },
  ...
  async getPermissionSchemeGrant<T = Models.PermissionGrant>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/permissionscheme/${parameters.schemeId}/permission/${parameters.permissionId}`,
      method: 'GET',
      params: {
        expand: parameters.expand,
      },
