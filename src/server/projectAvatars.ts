...
export class ProjectAvatars {
  ...
  async updateProjectAvatar<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/avatar`,
      method: 'PUT',
      data: {
  ...
  async deleteProjectAvatar<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/avatar/${parameters.id}`,
      method: 'DELETE',
    };
   ...
   *
   * `--url 'https://your-domain.atlassian.net/rest/api/latest/project/{projectIdOrKey}/avatar2'`
   *
  ...
  async createProjectAvatar<T = Models.Avatar>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/avatar2`,
      method: 'POST',
      params: {
        x: parameters.x,
        y: parameters.y,
  ...
  async getAllProjectAvatars<T = Models.ProjectAvatars>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/avatars`,
      method: 'GET',
    };
