...
export class ProjectComponents {
  ...
  async getComponent<T = Models.ProjectComponent>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/component/${parameters.id}`,
      method: 'GET',
    };
  ...
  async getComponentRelatedIssues<T = Models.ComponentIssuesCount>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/component/${parameters.id}/relatedIssueCounts`,
      method: 'GET',
    };
  ...
  async getProjectComponentsPaginated<T = Models.PageComponentWithIssueCount>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/component`,
      method: 'GET',
      params: {
  ...
  async getProjectComponents<T = Models.ProjectComponent[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/components`,
      method: 'GET',
    };
