...
export class ProjectPermissionSchemes {
  ...
  async getProjectIssueSecurityScheme<T = Models.SecurityScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectKeyOrId}/issuesecuritylevelscheme`,
      method: 'GET',
    };
  ...
  async getAssignedPermissionScheme<T = Models.PermissionScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectKeyOrId}/permissionscheme`,
      method: 'GET',
      params: {
  ...
  async assignPermissionScheme<T = Models.PermissionScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectKeyOrId}/permissionscheme`,
      method: 'PUT',
      params: {
  ...
  async getSecurityLevelsForProject<T = Models.ProjectIssueSecurityLevels>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectKeyOrId}/securitylevel`,
      method: 'GET',
    };
