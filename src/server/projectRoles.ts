...
export class ProjectRoles {
  ...
  async getProjectRoles<T = Record<string, string>>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/role`,
      method: 'GET',
    };
  ...
  async getProjectRole<T = Models.ProjectRole>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}/role/${parameters.id}`,
      method: 'GET',
      params: {
  ...
  async getProjectRoleDetails<T = Models.ProjectRoleDetails[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/roledetails`,
      method: 'GET',
      params: {
  ...
  async partialUpdateProjectRole<T = Models.ProjectRole>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/role/${parameters.id}`,
      method: 'POST',
      data: {
        name: parameters.name,
        description: parameters.description,
