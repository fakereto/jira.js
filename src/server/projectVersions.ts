...
export class ProjectVersions {
  ...
  async getProjectVersionsPaginated<T = Models.PageVersion>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/version`,
      method: 'GET',
      params: {
  ...
  async getProjectVersions<T = Models.Version[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/versions`,
      method: 'GET',
      params: {
        expand: typeof parameters !== 'string' && parameters.expand,
      },
  ...
  async getVersion<T = Models.Version>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${id}`,
      method: 'GET',
      params: {
        expand: typeof parameters !== 'string' && parameters.expand,
      },
  ...
  async updateVersion<T = Models.Version>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${parameters.id}`,
      method: 'PUT',
      data: {
        expand: parameters.expand,
        description: parameters.description,
  ...
  async mergeVersions<T = void>(parameters: Parameters.MergeVersions, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${parameters.id}/mergeto/${parameters.moveIssuesTo}`,
      method: 'PUT',
    };
  ...
  async moveVersion<T = Models.Version>(parameters: Parameters.MoveVersion, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${parameters.id}/move`,
      method: 'POST',
      data: {
  ...
  async getVersionRelatedIssues<T = Models.VersionIssueCounts>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${id}/relatedIssueCounts`,
      method: 'GET',
    };
  ...
  async deleteAndReplaceVersion<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${parameters.id}/removeAndSwap`,
      method: 'POST',
      data: {
  ...
  async getVersionUnresolvedIssues<T = Models.VersionUnresolvedIssuesCount>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/version/${id}/unresolvedIssueCount`,
      method: 'GET',
    };
