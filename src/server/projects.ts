...
export class Projects {
  ...
  async getRecent<T = Models.Project[]>(parameters?: Parameters.GetRecent, callback?: Callback<T>): Promise<void | T> {
    const config: RequestConfig = {
      url: '/rest/api/latest/project/recent',
      method: 'GET',
      params: {
  ...
  async getProject<T = Models.Project>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}`,
      method: 'GET',
      params: {
  ...
  async updateProject<T = Models.Project>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${parameters.projectIdOrKey}`,
      method: 'PUT',
      params: {
        expand: parameters.expand,
      },
  ...
  async archiveProject<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/archive`,
      method: 'POST',
    };
  ...
  async deleteProjectAsynchronously<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/delete`,
      method: 'POST',
    };
  ...
  async restore<T = Models.Project>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/restore`,
      method: 'POST',
    };
  ...
  async getAllStatuses<T = Models.IssueTypeWithStatus[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectIdOrKey}/statuses`,
      method: 'GET',
    };
  ...
  async getHierarchy<T = Models.ProjectIssueTypeHierarchy>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/project/${projectId}/hierarchy`,
      method: 'GET',
    };
