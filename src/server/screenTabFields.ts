...
export class ScreenTabFields {
  ...
  async getAllScreenTabFields<T = Models.ScreenableField[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${parameters.screenId}/tabs/${parameters.tabId}/fields`,
      method: 'GET',
      params: {
  ...
  async removeScreenTabField<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${parameters.screenId}/tabs/${parameters.tabId}/fields/${parameters.id}`,
      method: 'DELETE',
    };
  ...
  async moveScreenTabField<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${parameters.screenId}/tabs/${parameters.tabId}/fields/${parameters.id}/move`,
      method: 'POST',
      data: {
