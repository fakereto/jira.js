...
export class Screens {
  ...
  async getScreensForField<T = Models.PageScreenWithTab>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/field/${fieldId}/screens`,
      method: 'GET',
      params: {
  ...
  async addFieldToDefaultScreen<T = unknown>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/addToDefault/${fieldId}`,
      method: 'POST',
    };
  ...
  async updateScreen<T = Models.Screen>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${parameters.screenId}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async deleteScreen<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${screenId}`,
      method: 'DELETE',
    };
  ...
  async getAvailableScreenFields<T = Models.ScreenableField[]>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/screens/${screenId}/availableFields`,
      method: 'GET',
    };
