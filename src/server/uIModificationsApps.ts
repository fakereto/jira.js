...
export class UIModificationsApps {
  ...
  async getUiModifications<T = Models.PageUiModificationDetails>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/uiModifications',
      method: 'GET',
      params: {
  ...
  async updateUiModification<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/uiModifications/${parameters.uiModificationId}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async deleteUiModification<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/uiModifications/${uiModificationId}`,
      method: 'DELETE',
    };
