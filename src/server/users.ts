...
export class Users {
  ...
  async bulkGetUsersMigration<T = Models.UserMigration[]>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/user/bulk/migration',
      method: 'GET',
      params: {
  ...
  async getUserDefaultColumns<T = Models.ColumnItem[]>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/user/columns',
      method: 'GET',
      params: {
        accountId: parameters?.accountId,
      },
   ...
   * https://your-domain.atlassian.net/rest/api/latest/user/columns?accountId=5b10ac8d82e05b22cc7d4ef5'`
   *
   * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
   *
  ...
  async getUserEmail<T = Models.UnrestrictedUserEmail>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/user/email',
      method: 'GET',
      params: {
        accountId,
      },
  ...
  async getUserEmailBulk<T = Models.UnrestrictedUserEmail>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/user/email/bulk',
      method: 'GET',
      params: {
        accountId,
      },
  ...
  async getUserGroups<T = Models.GroupName[]>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/user/groups',
      method: 'GET',
      params: {
        accountId: parameters.accountId,
      },
