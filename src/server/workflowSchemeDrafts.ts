...
export class WorkflowSchemeDrafts {
  ...
  async createWorkflowSchemeDraftFromParent<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/createdraft`,
      method: 'POST',
    };
  ...
  async getWorkflowSchemeDraft<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/draft`,
      method: 'GET',
    };
  ...
  async updateWorkflowSchemeDraft<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/draft`,
      method: 'PUT',
      data: {
  ...
  async getDraftDefaultWorkflow<T = Models.DefaultWorkflow>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/draft/default`,
      method: 'GET',
    };
  ...
  async updateDraftDefaultWorkflow<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/draft/default`,
      method: 'PUT',
      data: {
  ...
  async getWorkflowSchemeDraftIssueType<T = Models.IssueTypeWorkflowMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/draft/issuetype/${parameters.issueType}`,
      method: 'GET',
    };
  ...
  async publishDraftWorkflowScheme<T = void>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/draft/publish`,
      method: 'POST',
      params: {
  ...
  async getDraftWorkflow<T = Models.IssueTypesWorkflowMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/draft/workflow`,
      method: 'GET',
      params: {
