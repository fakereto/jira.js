...
export class WorkflowSchemes {
  ...
  async getAllWorkflowSchemes<T = Models.PageWorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: '/rest/api/latest/workflowscheme',
      method: 'GET',
      params: {
  ...
  async getWorkflowScheme<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}`,
      method: 'GET',
      params: {
  ...
  async updateWorkflowScheme<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}`,
      method: 'PUT',
      data: {
        name: parameters.name,
        description: parameters.description,
  ...
  async getDefaultWorkflow<T = Models.DefaultWorkflow>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/default`,
      method: 'GET',
      params: {
        returnDraftIfExists: typeof parameters !== 'string' && parameters.returnDraftIfExists,
      },
  ...
  async updateDefaultWorkflow<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/default`,
      method: 'PUT',
      data: {
  ...
  async getWorkflowSchemeIssueType<T = Models.IssueTypeWorkflowMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/issuetype/${parameters.issueType}`,
      method: 'GET',
      params: {
  ...
  async getWorkflow<T = Models.IssueTypesWorkflowMapping>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${id}/workflow`,
      method: 'GET',
      params: {
  ...
  async updateWorkflowMapping<T = Models.WorkflowScheme>(
    ...
    const config: RequestConfig = {
      url: `/rest/api/latest/workflowscheme/${parameters.id}/workflow`,
      method: 'PUT',
      params: {
